                        ...
                        <div className="column mt-4">
                            ...
                            <p className="subtitle is-size-4 mr-2">
                              <span className="has-text-weight-bold">
                                ...
                                {orderProduct.attributes.product.data.attributes.price * orderProduct.attributes.amount} sum
                            </p>
                        </div>

                    </div>
                    <button className="button is-rounded is-fullwidth is-danger is-light"
                    onClick={deleteOrderProduct}
                    >Back to {orderProduct.attributes.product.data.attributes.name.slice(0,30)}..</button>
                </div>
